...
unlocked_room = Room('The Unlocked Room', None, 'dark_room_2', None, 'inside_home', None, None, "You are now inside "
                                                                                                "the "
                                                                                                "unlocked room.")
...
dark_hallway = Room('The Dark Hallway', None, None, 'dark_room_2', 'last_door', None, None, "You are inside a dark "
                                                                                            ...
                                                                                            "West-East.")
last_door = Room('The Last Door', None, None, 'dark_hallway', 'money_room', None, None, "It is the last door"
                                                                                        "and "
...
while playing:
    ...
    if player.current_location == money_room:
        ...
        break
    if player.current_location == dark_room_2 and ('pick up' in command.lower() or 'grab' in command.lower()):
        player.weapon = ak47
    if player.current_location == kitchen and ('pick up' in command.lower() or 'grab' in command.lower()):
        player.weapon = burst
